...
?>
        ...
        <div id="user"><div>
            ...
            $resultado2= $obj2->TIPO;
                ...
                <div id="menuindoor">
                    <div id="listaindoor">
                        <div><span>Deportes(M.Edición)</span>
                        <img src="../img/botonmas.png" onclick="location.href='.././admin/editabladeporte.php'"></div>
                        <div><span>Pistas(M.Edición)</span><img src="../img/botonmas.png" onclick="location.href='.././admin/editablapista.php'"></div>
                        <div><span>Reservas(M.Edición)</span><img src="../img/botonmas.png" onclick="location.href='.././admin/editablareserva.php'"></div>
                    </div>
                </div>
                <div id="estrellas">
